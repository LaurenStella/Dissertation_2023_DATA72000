...
print("Saving best LGBM model as 'Autoreg-4_lgbm.pickle' file")
pickle.dump(automl, open("Autoreg-4_lgbm.pickle", "wb"))
...
print("Saving test & y_pred column to 'y_pred_autoreg-4_lgbm.csv'")
observe_test.to_csv('y_pred_autoreg-4_lgbm.csv')
