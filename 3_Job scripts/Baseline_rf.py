...
print("Saving best Simple Regression Random Forest model as 'Reg_rf.pickle' file")
pickle.dump(automl, open("Reg_rf.pickle", "wb"))
...
print("Saving test & y_pred column to 'y_pred_reg_rf.csv'")
observe_test.to_csv('y_pred_reg_rf.csv')
...
plt.savefig('Random Forest Feature Importance.png', bbox_inches="tight", pad_inches=0.5)
