...
print("Saving best Autoregression-1 Random Forest model as 'Autoreg-2_rf.pickle' file")
pickle.dump(automl, open("Autoreg-2_rf.pickle", "wb"))
...
print("Saving test & y_pred column to 'y_pred_autoreg-2_rf.csv'")
observe_test.to_csv('y_pred_autoreg-2_rf.csv')
