...
print("Saving best Autoregression-1 Catboost model as '1-Lagged_full_catboost.pickle' file")
pickle.dump(automl, open("1-Lagged_full_catboost.pickle", "wb"))
...
print("Saving test & y_pred column to 'y_pred_1-lagged_full_catboost.csv'")
observe_test.to_csv('y_pred_1-lagged_full_catboost.csv')
