...
print("Saving best Random Forest model as 'Autoreg-3_rf.pickle' file")
pickle.dump(automl, open("Autoreg-3_rf.pickle", "wb"))
...
print("Saving test & y_pred column to 'y_pred_autoreg-3_rf.csv'")
observe_test.to_csv('y_pred_autoreg-3_rf.csv')
