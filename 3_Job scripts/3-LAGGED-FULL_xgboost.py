...
print("Saving best XGBoost model as '3-Lagged_full_xgboost.pickle' file")
pickle.dump(automl, open("3-Lagged_full_xgboost.pickle", "wb"))
...
print("Saving test & y_pred column to 'y_pred_3-lagged_full_xgboost.csv'")
observe_test.to_csv('y_pred_3-lagged_full_xgboost.csv')
