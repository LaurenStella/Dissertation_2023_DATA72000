...
print("Saving best partial XGBoost model as 'Autoreg-3_xgboost.pickle' file")
pickle.dump(automl, open("Autoreg-3_xgboost.pickle", "wb"))
...
print("Saving test & y_pred column to 'y_pred_autoreg-3_xgboost.csv'")
observe_test.to_csv('y_pred_autoreg-3_xgboost.csv')
