...
print("Saving best Simple Regression LGBM model as 'Reg_lgbm.pickle' file")
pickle.dump(automl, open("Reg_lgbm.pickle", "wb"))
...
print("Saving test & y_pred column to 'y_pred_reg_lgbm.csv'")
observe_test.to_csv('y_pred_reg_lgbm.csv')
...
plt.savefig('LightGBM Feature Importance.png', bbox_inches="tight", pad_inches=0.5)
