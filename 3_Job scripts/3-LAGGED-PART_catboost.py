...
print("Saving best Catboost model as 'Autoreg-3_catboost.pickle' file")
pickle.dump(automl, open("Autoreg-3_catboost.pickle", "wb"))
...
print("Saving test & y_pred column to 'y_pred_autoreg-3_catboost.csv'")
observe_test.to_csv('y_pred_autoreg-3_catboost.csv')
