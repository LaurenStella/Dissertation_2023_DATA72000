...
print("Saving best LightGBM model as '4-Autoreg_lgbm.pickle' file")
pickle.dump(automl, open("4-Autoreg_lgbm.pickle", "wb"))
...
print("Saving test & y_pred column to 'y_pred_4-autoreg_lgbm.csv'")
observe_test.to_csv('y_pred_4-autoreg_lgbm.csv')
