...
print("Saving best Autoregression-4 Linear Regression model as '4-lagged-autoreg_linear.pickle' file")
pickle.dump(reg, open("4-lagged-autoreg_linear.pickle", "wb"))
...
print("Saving test & y_pred column to 'y_pred_4-lagged-autoreg_linear.csv'")
observe_test.to_csv('y_pred_4-lagged-autoreg_linear.csv')
