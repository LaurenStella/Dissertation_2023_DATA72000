...
print("Saving best Autoregression-5 Linear Regression model as 'Autoreg-5_linear.pickle' file")
pickle.dump(reg, open("Autoreg-5_linear.pickle", "wb"))
...
print("Saving test & y_pred column to 'y_pred_autoreg-5_linear.csv'")
observe_test.to_csv('y_pred_autoreg-5_linear.csv')
