...
print("Saving best Autoregression-1 Catboost model as 'Autoreg-1_catboost.pickle' file")
pickle.dump(automl, open("Autoreg-1_catboost.pickle", "wb"))
...
print("Saving test & y_pred column to 'y_pred_autoreg-1_catboost.csv'")
observe_test.to_csv('y_pred_autoreg-1_catboost.csv')
