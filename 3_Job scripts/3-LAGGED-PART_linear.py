...
print("Saving best Autoregression-3 Linear Regression model as 'Autoreg-3_linear.pickle' file")
pickle.dump(reg, open("Autoreg-3_linear.pickle", "wb"))
...
print("Saving test & y_pred column to 'y_pred_autoreg-3_linear.csv'")
observe_test.to_csv('y_pred_autoreg-3_linear.csv')
