...
print("Saving best CatBoost model as '2-lagged-autoreg_catboost.pickle' file")
pickle.dump(automl, open("2-lagged-autoreg_catboost.pickle", "wb"))
...
print("Saving test & y_pred column to 'y_pred_2-lagged-autoreg_catboost.csv'")
observe_test.to_csv('y_pred_2-lagged-autoreg_catboost.csv')
