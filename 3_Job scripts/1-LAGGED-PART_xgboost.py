...
print("Saving best partial Autoregression-1 XGBoost model as 'Autoreg-1_xgboost.pickle' file")
pickle.dump(automl, open("Autoreg-1_xgboost.pickle", "wb"))
...
print("Saving test & y_pred column to 'y_pred_autoreg-1_xgboost.csv'")
observe_test.to_csv('y_pred_autoreg-1_xgboost.csv')
