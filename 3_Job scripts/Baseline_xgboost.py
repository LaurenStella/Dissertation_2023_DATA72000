...
print("Saving best Simple Regression XGBoost model as 'Reg_xgboost.pickle' file")
pickle.dump(automl, open("Reg_xgboost.pickle", "wb"))
...
print("Saving test & y_pred column to 'y_pred_reg_xgboost.csv'")
observe_test.to_csv('y_pred_reg_xgboost.csv')
...
plt.savefig('XGBoost Feature Importance.png', bbox_inches="tight", pad_inches=0.5)
