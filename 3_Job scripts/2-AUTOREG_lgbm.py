...
print("Saving best Autoregression-2 LightGBM model as '2-Autoreg_lgbm.pickle' file")
pickle.dump(automl, open("2-Autoreg_lgbm.pickle", "wb"))

##Best estimator
print('Best LightGBM learner:', automl.best_estimator)
print('Best hyperparmeter config:', automl.best_config)
print('Best MSE score on validation data: {0:.5g}'.format(automl.best_loss))
...
print("Saving test & y_pred column to 'y_pred_2-autoreg_lgbm.csv'")
observe_test.to_csv('y_pred_2-autoreg_lgbm.csv')
