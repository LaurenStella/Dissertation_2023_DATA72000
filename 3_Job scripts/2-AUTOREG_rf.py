...
print("Saving best Autoregression-2 Random Forest model as '2-Autoreg_rf.pickle' file")
pickle.dump(automl, open("2-Autoreg_rf.pickle", "wb"))
...
print("Saving test & y_pred column to 'y_pred_2-autoreg_rf.csv'")
observe_test.to_csv('y_pred_2-autoreg_rf.csv')
