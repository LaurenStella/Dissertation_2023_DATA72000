...
print("Saving best Random Forest model as '3-Autoreg_rf.pickle' file")
pickle.dump(automl, open("3-Autoreg_rf.pickle", "wb"))
...
print("Saving test & y_pred column to 'y_pred_3-autoreg_rf.csv'")
observe_test.to_csv('y_pred_3-autoreg_rf.csv')
