...
print("Saving best Autoregression-2 CatBoost model as '3-Autoreg_catboost.pickle' file")
pickle.dump(automl, open("3-Autoreg_catboost.pickle", "wb"))
...
print("Saving test & y_pred column to 'y_pred_3-autoreg_catboost.csv'")
observe_test.to_csv('y_pred_3-autoreg_catboost.csv')
