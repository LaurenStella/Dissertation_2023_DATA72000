...
print("Saving best Autoregression-2 Catboost model as '3-Lagged_full_catboost.pickle' file")
pickle.dump(automl, open("3-Lagged_full_catboost.pickle", "wb"))
...
print("Saving test & y_pred column to 'y_pred_3-lagged_full_catboost.csv'")
observe_test.to_csv('y_pred_3-lagged_full_catboost.csv')
