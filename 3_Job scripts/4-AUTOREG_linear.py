...
print("Saving best Autoregression-4 Linear Regression model as '4-Autoreg_linear.pickle' file")
pickle.dump(reg, open("4-Autoreg_linear.pickle", "wb"))
...
print("Saving test & y_pred column to 'y_pred_4-autoreg_linear.csv'")
observe_test.to_csv('y_pred_4-autoreg_linear.csv')

##ONLY NEED TO SAVE THIS ONCE (PER NUMBER OF LAGS), NOT FOR EACH MODEL
#observe_train = df_train.iloc[:,:5]
#print("Saving train to 'train_label_autoreg-4.csv'")
#observe_train.to_csv('train_label_autoreg-4.csv')