...
print("Saving best Autoregression-1 CatBoost model as '1-lagged-autoreg_catboost.pickle' file")
pickle.dump(automl, open("1-lagged-autoreg_catboost.pickle", "wb"))
...
print("Saving test & y_pred column to 'y_pred_1-lagged-autoreg_catboost.csv'")
observe_test.to_csv('y_pred_1-lagged-autoreg_catboost.csv')
