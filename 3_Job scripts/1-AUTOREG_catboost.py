...
print("Saving best Autoregression-1 CatBoost model as '1-Autoreg_catboost.pickle' file")
pickle.dump(automl, open("1-Autoreg_catboost.pickle", "wb"))
...
print("Saving test & y_pred column to 'y_pred_1-autoreg_catboost.csv'")
observe_test.to_csv('y_pred_1-autoreg_catboost.csv')

##ONLY NEED TO SAVE THIS ONCE (PER NUMBER OF LAGS), NOT FOR EACH MODEL
#observe_train = df_train.iloc[:,:5]
#print("Saving train to 'train_label_autoreg-1.csv'")
#observe_train.to_csv('train_label_autoreg-1.csv')