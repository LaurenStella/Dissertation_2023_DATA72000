...
print("Saving best Autoregression-2 LGBM model as 'Autoreg-2_lgbm.pickle' file")
pickle.dump(automl, open("Autoreg-2_lgbm.pickle", "wb"))
...
print("Saving test & y_pred column to 'y_pred_autoreg-2_lgbm.csv'")
observe_test.to_csv('y_pred_autoreg-2_lgbm.csv')
