...
print("Saving best partial XGBoost model as 'Autoreg-4_xgboost.pickle' file")
pickle.dump(automl, open("Autoreg-4_xgboost.pickle", "wb"))
...
print("Saving test & y_pred column to 'y_pred_autoreg-4_xgboost.csv'")
observe_test.to_csv('y_pred_autoreg-4_xgboost.csv')
