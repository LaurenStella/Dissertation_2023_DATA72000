...
print("Saving best partial Autoregression-2 XGBoost model as 'Autoreg-2_xgboost.pickle' file")
pickle.dump(automl, open("Autoreg-2_xgboost.pickle", "wb"))
...
print("Saving test & y_pred column to 'y_pred_autoreg-2_xgboost.csv'")
observe_test.to_csv('y_pred_autoreg-2_xgboost.csv')
