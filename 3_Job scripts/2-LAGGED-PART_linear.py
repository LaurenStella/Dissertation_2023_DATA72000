...
print("Saving best Autoregression-2 Linear Regression model as 'Autoreg-2_linear.pickle' file")
pickle.dump(reg, open("Autoreg-2_linear.pickle", "wb"))
...
print("Saving test & y_pred column to 'y_pred_autoreg-2_linear.csv'")
observe_test.to_csv('y_pred_autoreg-2_linear.csv')
