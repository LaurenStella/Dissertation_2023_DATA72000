...
print("Saving best Autoregression-1 XGBoost model as '1-Autoreg_xgboost.pickle' file")
pickle.dump(automl, open("1-Autoreg_xgboost.pickle", "wb"))
...
print("Saving test & y_pred column to 'y_pred_1-autoreg_xgboost.csv'")
observe_test.to_csv('y_pred_1-autoreg_xgboost.csv')
