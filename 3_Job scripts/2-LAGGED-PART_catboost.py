...
feature_cols = ["FSNS", "TREFHT"] ##using 3600 time budget
...
print("Saving best Autoregression-2 Catboost model as 'Autoreg-2_catboost.pickle' file")
pickle.dump(automl, open("Autoreg-2_catboost.pickle", "wb"))
...
print("Saving test & y_pred column to 'y_pred_autoreg-2_catboost.csv'")
observe_test.to_csv('y_pred_autoreg-2_catboost.csv')
