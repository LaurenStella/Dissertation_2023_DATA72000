...
print("Saving best Autoregression-2 Linear Regression model as '2-Autoreg_linear.pickle' file")
pickle.dump(reg, open("2-Autoreg_linear.pickle", "wb"))
...
print("Saving test & y_pred column to 'y_pred_2-autoreg_linear.csv'")
observe_test.to_csv('y_pred_2-autoreg_linear.csv')

##ONLY NEED TO SAVE THIS ONCE (PER NUMBER OF LAGS), NOT FOR EACH MODEL
#observe_train = df_train.iloc[:,:5]
#print("Saving train to 'train_label_autoreg-2.csv'")
#observe_train.to_csv('train_label_autoreg-2.csv')