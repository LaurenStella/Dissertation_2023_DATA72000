...
print("Saving best Autoregression-1 LGBM model as 'Autoreg-1_lgbm.pickle' file")
pickle.dump(automl, open("Autoreg-1_lgbm.pickle", "wb"))
...
print("Saving test & y_pred column to 'y_pred_autoreg-1_lgbm.csv'")
observe_test.to_csv('y_pred_autoreg-1_lgbm.csv')
