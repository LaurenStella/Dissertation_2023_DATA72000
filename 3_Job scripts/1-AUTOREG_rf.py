...
print("Saving best Autoregression-1 Random Forest model as '1-Autoreg_rf.pickle' file")
pickle.dump(automl, open("1-Autoreg_rf.pickle", "wb"))

##Best estimator
print('Best Random Forest learner:', automl.best_estimator)
print('Best hyperparmeter config:', automl.best_config)
print('Best MSE score on validation data: {0:.5g}'.format(1-automl.best_loss))
...
print("Saving test & y_pred column to 'y_pred_1-autoreg_rf.csv'")
observe_test.to_csv('y_pred_1-autoreg_rf.csv')
